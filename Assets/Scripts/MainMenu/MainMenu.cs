...
public class MainMenu : MonoBehaviour {
	...
	public GameObject hostOn, joinOn, TiltButton, StartButton, OptionButton, ExitButton, NameButton, BackButton, MuteButton, OnOffButton;
